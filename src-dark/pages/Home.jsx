          ...
          <div className="mx-auto grid w-full grid-cols-1 items-center gap-0 lg:grid-cols-[65%_35%]">
            ...
            <div className="mx-2 md:mx-20 flex w-full flex-col justify-start gap-5 leading-[1.4]">
              <h1 className="font-heading font-bold uppercase tracking-[0%] text-left">
                <div
                  className="block w-full text-[32px] text-black transition-colors duration-300 dark:text-white text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]
"
                >
                  BUILD THE FUTURE WITH
                </div>
                <div
                  className="block w-full text-[32px] text-brand-blue transition-colors duration-300 dark:[-webkit-text-stroke:1px_#ffffff] text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]
"
                >
...
"
        ...
        <div className="relative">
          ...
          <div ref={servicesRef} className="relative ">
            <section
              className={`sticky top-0 z-[10] bg-white pb-4  transition-all duration-700 dark:bg-black sm:top-0 sm:pb-4 sm:pt-6 md:top-0 md:pb-8 md:pt-8 ${isServicesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-8 lg:px-12">
                <h2 className="mx-auto max-w-full text-center font-heading font-bold uppercase leading-[1.1] tracking-[0%]">
                  <div className="block text-[32px] transition-colors duration-300 sm:text-[40px] md:text-[48px] lg:text-[76px] xl:text-[76px]">
                ...
                <p className="mx-auto mt-3 max-w-full text-center text-xs leading-[1.6] text-black/75 transition-colors duration-300 dark:text-white/75 sm:mt-4 sm:text-xl leading-[1.6] sm:leading-[1.65] md:mt-6 md:max-w-[920px] md:text-base lg:text-xl">
          ...
          <div ref={trustRef} className="relative ">
            <section
              className={`sticky top-0 z-[20] bg-white pb-4 pt-4 transition-all duration-700 dark:bg-black sm:top-0 sm:pb-4 sm:pt-6 md:top-0 md:pb-8 md:pt-8 lg:pb-14 lg:pt-8`}
            >
              <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-8 lg:px-12">
                    ...
                    >
                      <div className="grid grid-cols-1 items-start gap-3 sm:gap-4 md:items-center md:grid-cols-[1fr_160px] lg:grid-cols-[1fr_220px] lg:gap-6 lg:grid-cols-[1fr_220px]">
                        <div className="w-full md:w-[600px] lg:w-[680px]">
                          <h3 className="font-heading text-xl font-bold text-black transition-colors duration-300 dark:text-white sm:text-xl md:text-2xl lg:text-2xl line-clamp-2">
                            {card.title}
                          </h3>
                          <p className="mt-2 min-h-[3.1em] overflow-hidden text-base leading-[1.55] text-black/75 transition-colors duration-300 dark:text-white/75 sm:mt-3 sm:text-xl sm:leading-[1.6] md:text-xl [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2]">
                            {card.description}
                          </p>
                        </div>
          ...
          <div ref={industriesRef} className="relative ">
            <section
              className={`sticky top-0 z-[30] bg-white pb-4 pt-4 transition-all duration-700 dark:bg-black sm:top-0 sm:pb-4 sm:pt-6 md:top-0 md:pb-8 md:pt-8 lg:pb-14 lg:pt-8`}
            >
              <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-8 lg:px-12">
                    ...
                    <div className="w-full rounded-lg border border-brand-blue/30 bg-black/[0.03] p-4 shadow-[0_8px_24px_rgba(0,0,0,0.15)] transition-all duration-300 hover:shadow-[0_16px_48px_rgba(0,0,0,0.25)] hover:-translate-y-2 hover:scale-[1.02] dark:border-white/30 dark:bg-white/[0.03] dark:shadow-[0_8px_24px_rgba(0,0,0,0.35)] dark:hover:shadow-[0_16px_48px_rgba(0,0,0,0.55)] sm:rounded-xl sm:p-5 md:rounded-2xl md:p-6 md:shadow-[0_12px_32px_rgba(0,0,0,0.18)] md:hover:shadow-[0_24px_64px_rgba(0,0,0,0.3)] dark:md:shadow-[0_12px_32px_rgba(0,0,0,0.45)] dark:md:hover:shadow-[0_24px_64px_rgba(0,0,0,0.65)] md:col-start-1 md:col-end-3 lg:col-start-2 lg:col-end-3">
                      <div className="flex flex-col gap-4">
                        <div className="flex items-center justify-between gap-1">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded bg-brand-blue text-base font-bold text-white transition-colors duration-300 dark:bg-white dark:text-brand-blue sm:h-12 sm:w-12 sm:text-xl md:h-10 md:w-10">
                        ...
                        <div className="mt-2">
                          <h3 className="no-stroke text[32px] font-heading font-bold text-brand-blue transition-colors duration-300 dark:text-white sm:text-xl md:text-xl">
                            {industriesCards[0].title}
                          </h3>
                          <p className="mt-2 text-lg leading-[1.55] text-black/75 transition-colors duration-300 dark:text-white/75 sm:mt-3 sm:text-xl leading-[1.6] sm:leading-[1.6] md:text-base">
                    ...
                    {industriesCards.slice(1, 3).map((card) => (
                      ...
                      >
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="mt-2">
                            <h3 className="no-stroke font-heading text-base font-bold text-brand-blue transition-colors duration-300 dark:text-white sm:text-xl md:text-xl">
                              {card.title}
                            </h3>
                            <p className="mt-2 text-xs leading-[1.55] text-black/75 transition-colors duration-300 dark:text-white/75 sm:mt-3 sm:text-xl leading-[1.6] sm:leading-[1.6] md:text-base">
                              {card.description}
                            </p>
                          </div>
                        </div>
                ...
                <div className="mt-6 overflow-hidden sm:mt-8 md:mt-10 max-w-5xl mx-auto">
                  ...
                  >
                    {workCards.map((card) => (
                      ...
                      >
                        <div className="mx-auto flex min-h-[250px] sm:min-h-[280px] lg:min-h-[300px]  w-full max-w-[360px] flex-col rounded-xl border border-black/25 bg-white p-6 shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition-all duration-300 hover:border-2  hover:shadow-[0_16px_48px_rgba(0,0,0,0.18)] hover:-translate-y-1 dark:border-white/30 dark:bg-[#0b0b0b] dark:shadow-[0_10px_30px_rgba(0,0,0,0.55)] dark:hover:shadow-[0_18px_60px_rgba(0,0,0,0.75)] sm:p-7">
                          <h3 className="font-heading  text[20px] font-bold text-black transition-colors duration-300 dark:text-white sm:text-xl">
                            {card.title}
                          </h3>
                          <div className="mt-4 h-px w-full bg-brand-blue/70" />
                          <p
                            className="mt-5  text[20px]
                         leading-[1.65] text-black/80 transition-colors duration-300 dark:text-white/80 sm:text-base"
                          >
                            {card.description}
                          </p>
                        </div>
                ...
                <div className="mt-8 grid grid-cols-1 gap-6 sm:mt-10 md:mt-12 md:grid-cols-1 lg:grid-cols-[300px_1fr] lg:gap-8">
                  ...
                  <div className="flex flex-col gap-3 sm:gap-4">
                    {techStackItems.map((item, index) => (
                      ...
                      >
                        <span className="font-heading text-xs dark:text-white font-normal sm:text-xl leading-[1.6] md:text-base">
                          {item.name}
                        </span>
                      </button>
                    ))}
                          ...
                          <div className="flex flex-col gap-3">
                            {techStackItems[selectedTechStack].description
                              ...
                              .map((paragraph, idx) => (
                                <p
                                  key={idx}
                                  className="text-xl leading-[1.6] leading-relaxed text-black/80 transition-all duration-500 ease-in-out dark:text-white/80 sm:text-base md:text-xl"
                                >
                                  {paragraph}
                                </p>
                              ))}
                            ...
                            <div className="mt-4">
                              ...
                              <ul className="flex flex-col gap-2">
                                {techStackItems[
                                  ...
                                  <li
                                    key={idx}
                                    className="text-xl leading-[1.6] text-black/80 transition-all duration-500 ease-in-out dark:text-white/80 sm:text-base"
                                  >
                                    • {tech}
                                  </li>
                                ))}
              ...
              <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-8 lg:px-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-6 lg:gap-6 max-w-5xl mx-auto">
                  {testimonials.map((testimonial) => (
                    <div
                      key={testimonial.id}
                      className="flex flex-col h-full rounded-lg border border-gray-200 bg-white p-6 shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-all duration-300 hover:border-4 hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)] hover:-translate-y-1 dark:border-white/30 dark:bg-transparent dark:shadow-[0_4px_12px_rgba(0,0,0,0.3)] dark:hover:shadow-[0_8px_24px_rgba(0,0,0,0.5)] sm:p-8"
                    >
                      <p className="text-lg leading-[1.6] sm:text-base md:text-lg leading-relaxed text-black/80 mb-auto transition-colors duration-300 dark:text-white/80 flex-grow">
                        "{testimonial.quote}"
                      </p>
                      {/* Blue Underline */}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        />
                        <p className="no-stroke font-heading font-semibold text-brand-blue text-lg leading-[1.6] sm:text-base md:text-lg dark:text-white">
                          {testimonial.name}
                        </p>
                      </div>
                    </div>
              ...
              <div className="mx-auto max-w-layout px-4 ">
                <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-8 sm:gap-10 lg:gap-12 xl:gap-16 items-center">
                  ...
                  <div className="m-[30px] flex flex-col ">
                    ...
                    <p className="text-xl  mt-5 leading-[1.6] sm:text-base md:text-xl leading-[1.45] text-black/80 transition-colors duration-300 dark:text-white/80 max-w-[600px]">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="w-full max-w-[400px] overflow-hidden rounded-2xl border-black/10 bg-black/[0.03] transition-colors duration-300 dark:border-white/20 dark:bg-white/[0.04]">
                      <img
                        src={readyToBuildImg}
                        alt="Ready to build"
              ...
              <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-8 lg:px-12">
                <h2 className="mx-auto max-w-full text-center font-heading font-bold uppercase leading-[1.1] tracking-[0%] sm:max-w-[1200px] mb-8 sm:mb-12 lg:mb-16">
                  <div className="block text-[34px] leading-[1] tracking-[0.02em] transition-colors duration-300 sm:text-[46px] md:text-[56px] lg:text-[68px] xl:text-[78px]">
                    <span className="text-brand-blue dark:text-brand-blue dark:[-webkit-text-stroke:1px_#ffffff]">
                  ...
                  >
                    <div className="rounded-lg border border-gray-200 bg-white p-4 transition-all duration-300 dark:border-white/25 dark:bg-transparent">
                      {faqs.map((faq, index) => (
                        ...
                        >
                          <h3 className="font-normal text-base sm:text-xl md:text-xl mb-3 text-black dark:text-white">
                            {faq.id}. {faq.question}
                          </h3>
                          <p className="text-xl leading-[1.6] sm:text-base md:text-xl leading-[1.5] text-black/80 dark:text-white/80 mb-2">
                            {faq.answer}
                          </p>
                          {faq.bulletPoints && (
                            <ul className="mt-3 space-y-1.5">
                              {faq.bulletPoints.map((point, idx) => (
                                <li
                                  key={idx}
                                  className="text-xl leading-[1.6] sm:text-base md:text-xl leading-[1.5] text-black/80 dark:text-white/80 flex items-start gap-2"
                                >
