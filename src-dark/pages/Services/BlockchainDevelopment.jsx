...
const BlockchainDevelopment = () => {
  ...
  <Helmet>
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      {/* Hero Section */}
      <section className="relative w-full bg-white pt-4 pb-4 transition-colors duration-300 dark:bg-black sm:pb-16 md:pt-6 md:pb-18 lg:pt-8 lg:pb-18 xl:pt-10 xl:pb-10">
        {/* Background Decorative Lines */}
        <div className="absolute z-0 opacity-10 dark:opacity-20">
...
text-[34px] sm:text-[44px] md:text-[54px] lg:text-[60px]
leading-[1.1] sm:leading-[1.15]"
            ...
            <div className="flex flex-col gap-4 max-w-[650px]">
              <p className="font-normal text-xl leading-[1.6] text-black transition-colors duration-300 dark:text-white sm:text-base md:text-lg lg:text-xl">
      ...
      <section className="w-full bg-white pt-4 pb-16 transition-colors duration-300 dark:bg-black sm:pt-8 sm:pb-10">
              ...
              >
                <div className="flex flex-col sm:flex-row h-full items-start sm:items-center justify-between gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="font-sans text-2xl font-bold leading-tight text-black dark:text-white text-lg text-sm sm:text-base md:text-lg">
                      {solution.title}
                    </h3>
                    <p className="mt-4 font-sans text-base font-medium leading-[1.6] text-black/70 dark:text-white/80 text-sm sm:text-base md:text-lg">
                      {solution.desc}
                    </p>
                  </div>
                    ...
                    <div className="group relative w-full max-w-[360px] transition-all duration-300">
                      ...
                      <div className="relative h-full rounded-[24px] border border-brand-blue/10 bg-white p-8 transition-all duration-300 dark:border-white/30 dark:bg-black">
                        <div className="flex items-start justify-between gap-4">
                          <h3 className="no-stroke font-heading text-[25px] font-bold leading-tight text-brand-blue transition-colors duration-300 dark:text-white ">
                            {card.title}
                          </h3>
                        ...
                        <p className="mt-6 font-sans text-[20px] leading-[1.6] font-medium leading-[1.6] text-black/70 transition-colors duration-300 dark:text-white sm:text-small">
                          {card.desc}
                        </p>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
                  {group.items.map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-center hover:border-brand-blue hover:bg-gradient-to-b hover:from-white hover:to-[#cfe6fb] rounded-full hover:border-brand-blue hover:text-brand-blue border border-black/15 bg-white px-4 py-2 text-center font-sans text-xl leading-[1.6] font-medium text-black/80 shadow-[0_6px_16px_rgba(0,0,0,0.10)] transition-colors duration-300 dark:border-white/10 dark:bg-black/90 dark:text-white dark:shadow-[0_6px_16px_rgba(0,0,0,0.65)]"
                    >
                      {item}
                    </div>
                  ))}
