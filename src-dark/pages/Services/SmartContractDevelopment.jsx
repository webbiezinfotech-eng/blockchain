...
const SmartContractDevelopment = () => {
  ...
  <Helmet>
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      {/* Hero Section */}
      <section className="relative w-full bg-white pt-4 pb-4 transition-colors duration-300 dark:bg-black sm:pb-16 md:pt-6 md:pb-4 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-10">
 ...
 flex w-full flex-col justify-start gap-5 leading-[1.4]">
            <h2 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block text-[38px] leading-[1.2] sm:text-[52px] sm:leading-[1.25] lg:text-[68px] lg:leading-[1.4]">
            ...
            <p className="max-w-[720px] font-sans text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75">
      ...
      <section className="w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pt-10 sm:pb-12">
        <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14
">
          <div className="mb-12 text-center">
            <h2 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white text-[26px] sm:text-[36px] md:text-[48px] lg:text-[72px]
">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[42%_58%] lg:gap-14">
            ...
            <div className="flex w-full flex-col gap-5">
              {securityStandards.map((it) => (
                ...
                >
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg  border-brand-blue/40 bg-white/80 text-brand-blue transition-colors duration-300 dark:border-white/35 dark:bg-black/30 dark:text-white">
...
">
          <div className="mb-12 text-center">
            <h2 className="font-heading text-[44px] font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white text-[26px] sm:text-[36px] md:text-[48px] lg:text-[72px]">
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-12 md:grid-cols-2">
            {contractTypes.slice(0, 6).map((c) => (
              <div
                key={c.title}
                className="flex flex-col sm:flex-row items-start sm:items-stretch gap-6 rounded-[10px] border border-black/10 bg-gradient-to-b from-white to-[#cfe6fb] p-4 hover:border-2 hover:shadow-lg hover:shadow-blue/80 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300 md:h-[260px] lg:h-[280px] dark:border-white dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]"
              >
                <div className="flex-1">
                  <h3 className="font-sans text-lg sm:text-xl md:text-2xl font-bold leading-snug text-black transition-colors duration-300 dark:text-white">
                    {c.title}
                  </h3>
                  <p className="mt-4 font-sans text-sm sm:text-base md:text-lg font-medium leading-[1.65] text-black/70 transition-colors duration-300 dark:text-white/80">
                    {c.desc}
                  </p>
                </div>
          ...
          <div className="mt-10 flex justify-center">
            <div className="w-full max-w-[760px]">
              <div className="flex flex-col sm:flex-row items-start sm:items-stretch gap-6 rounded-[10px] border border-black/10 bg-gradient-to-b from-white to-[#cfe6fb] p-6 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300 md:h-[260px] lg:h-[280px] dark:border-white dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]">
                <div className="flex-1">
                  <h3 className="font-sans text-lg sm:text-xl md:text-2xl font-bold leading-snug text-black transition-colors duration-300 dark:text-white ">
...
">
          <div className="mb-12 text-center">
            <h2 className="font-heading  font-bold uppercase tracking-tight transition-colors duration-300 text-[26px] sm:text-[36px] md:text-[48px] lg:text-[72px]">
