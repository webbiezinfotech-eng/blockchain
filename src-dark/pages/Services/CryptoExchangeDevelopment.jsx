...
const CryptoExchangeDevelopment = () => {
  ...
  return (
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
        ...
        <div className="mx-auto grid w-full max-w-layout grid-cols-1 items-center gap-10  lg:grid-cols-[58%_42%] px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="flex w-full flex-col gap-6">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block text-[26px] leading-[1.2] sm:text-[36px] sm:leading-[1.25]  md:text-[48px] lg:text-[76px] lg:leading-[1.35]">
                FULL-SCALE CRYPTO
              </span>
              <span className="block text-[26px] leading-[1.2] sm:text-[36px] sm:leading-[1.25]  md:text-[48px] lg:text-[76px] lg:leading-[1.35]">
                EXCHANGE DEVELOPMENT
              </span>
              <span className="block text-[26px] leading-[1.25] sm:text-[36px] sm:leading-[1.25]  md:text-[48px] lg:text-[76px] lg:leading-[1.25]">
                FOR{' '}
            ...
            <p className="max-w-[760px] font-sans font-medium leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75 text-sm sm:text-base md:text-lg lg:text-xl">
      ...
      {/* Types of Exchanges */}
      <section className="w-full bg-white py-4 transition-colors duration-300 dark:bg-black sm:py-10">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="mb-10 text-center">
            <h2 className="font-heading text-[24px] font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white sm:text-[36px] md:text-[48px] lg:text-[72px]">
      ...
      <section className="w-full bg-white py-8 transition-colors duration-300 dark:bg-black sm:py-10">
        <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="font-heading text-[22px] font-bold uppercase tracking-tight sm:text-[32px] md:text-[44px] lg:text-[60px]">
  ...
  "
              >
                <div className="relative w-full aspect-[3/4]">
                  ...
                  <div className="relative z-10 flex flex-col justify-center h-full px-6 sm:px-8 md:px-10">
                    ...
                    <p className="mt-3 text-[13px] sm:text-[14px] leading-[1.6] text-black/80 dark:text-white/80 text-center">
                      {f.desc}
                    </p>
          ...
          <div className="mt-6 flex items-center justify-center gap-5 sm:gap-6">
            <button
              ...
              className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full border border-black/20 transition-all duration-300 hover:bg-brand-blue hover:text-white dark:border-white/30"
            >
      ...
      <section className="w-full bg-white  transition-colors duration-300 dark:bg-black">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-8 lg:px-[3rem]">
          <div className="">
            <h2 className="font-heading text-[24px] pb-8 font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white sm:text-[36px] md:text-[48px] lg:text-[72px]">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[56%_44%] lg:gap-14">
            <div className="flex w-full flex-col gap-3">
              {securityStack.map((label, idx) => (
                ...
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border-brand-blue/35 bg-black/[0.02] text-brand-blue transition-colors duration-300 dark:border-white/30 dark:bg-white/[0.05] dark:text-white">
...
">
    ...
    <section className="w-full bg-white py-6 transition-colors duration-300 dark:bg-black sm:py-10">
  <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">

    {/* Heading */}
    <div className="mb-8 sm:mb-12 text-center">
      <h2 className="font-heading text-[22px] font-bold uppercase tracking-tight text-black dark:text-white sm:text-[32px] md:text-[44px] lg:text-[60px]">
