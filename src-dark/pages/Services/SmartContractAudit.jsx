...
const SmartContractAudit = () => {
  ...
  <Helmet>
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      {/* Hero */}
      <section className="relative w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pb-16 md:pt-6 md:pb-14 lg:pt-8 lg:pb-14 xl:pt-10 xl:pb-12">
        <div className="mx-auto grid w-full grid-cols-1 items-start gap-0 lg:grid-cols-[65%_35%]">
          ...
          <div className="px-4 sm:px-6 md:px-10 lg:px-16  flex w-full flex-col justify-start gap-5 leading-[1.4]">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block  leading-[1.2]  sm:leading-[1.35] text-[24px] sm:text-[36px] md:text-[48px] lg:text-[68px] lg:leading-[1.35]">
            ...
            <p className="max-w-[720px] font-sans font-medium leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75 text-sm sm:text-base md:text-lg lg:text-xl">
      ...
      <section className="w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pt-8 sm:pb-10">
        <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="mb-10 text-center">
            <h2 className="font-heading  font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white text-[24px] sm:text-[36px] md:text-[48px] lg:text-[64px]">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[42%_58%] lg:gap-14">
            ...
            <div className="flex w-full flex-col gap-4 lg:max-w-[480px]">
              {auditProcess.map((it) => (
                ...
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg  border-brand-blue/40 bg-white/80 text-brand-blue transition-colors duration-300 dark:border-white/35 dark:bg-black/30 dark:text-white">
                    <img src={it.icon} alt="" className="h-6 w-6 sm:h-8 sm:w-8 object-contain" loading="lazy" />
                  </div>
                  <p className="font-sans font-semibold text-black transition-colors duration-300 dark:text-white text-sm sm:text-base md:text-lg">
                    {it.label}
                  </p>
                </div>
              ))}
  ...
  lg:place-items-stretch">
          ...
          transition-colors duration-300 dark:border-white/25
          dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]

          lg:${idx % 2 === 0 ? '-translate-y-6' : 'translate-y-6'}
        `}
                >
                  <div className="mx-auto mb-4 flex h-10 w-10 sm:h-14 sm:w-14
 items-center justify-center rounded-lg border border-brand-blue/45 bg-white dark:bg-black">
                    <img src={i.icon} alt="" className="h-10 w-10 object-contain" />
                  </div>

                  <p className="font-sans text-sm sm:text-base md:text-lg font-semibold leading-snug text-black dark:text-white">
                    {i.t}
                  </p>

                  {/* Connector down */}
                  <span className="pointer-events-none hidden lg:block">
                    <span className="absolute left-1/2 top-full h-20 -translate-x-1/2 border-l-2 border-dashed border-brand-blue/60 dark:border-white/50" />
                  </span>
                </div>
              ))}
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="mx-auto mt-20 h-[6px] w-[100%] rounded-full bg-brand-blue dark:bg-white" />
            </div>
        ...
        `}
                >
                  {/* Connector up */}
                  <span className="pointer-events-none hidden lg:block">
                    <span className="absolute hover:border-brand-blue left-1/2 bottom-full h-20 -translate-x-1/2 border-l-2 border-dashed border-brand-blue/60 dark:border-white/50" />
                  </span>
 ...
 font-bold uppercase tracking-wide text-brand-blue transition-colors duration-300 dark:text-white">
                Automated Tools
              </h3>
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                {automatedTools.map((t) => (
                  <span
                    key={t}
                    className="rounded-full hover:border-brand-blue hover:bg-gradient-to-b hover:from-white hover:to-[#cfe6fb]  border border-black/10 bg-white font-sans text-sm sm:text-base px-4 py-1.5 leading-[1.6] font-semibold text-black/80 shadow-[0_6px_16px_rgba(0,0,0,0.08)] transition-colors duration-300 dark:border-white/15 dark:bg-black dark:text-white"
                  >
                    {t}
                  </span>
                ))}
            ...
            <div className="rounded-[12px] border border-black/10 bg-white p-6 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300 dark:border-white/25 dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]">
              <h3 className="text-center font-heading text-sm sm:text-base md:text-lg font-bold uppercase tracking-wide text-brand-blue transition-colors duration-300 dark:text-white">
                Manual Testing
              </h3>
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                {manualTesting.map((t) => (
                  <span
                    key={t}
                    className="rounded-full hover:border-brand-blue hover:bg-gradient-to-b hover:from-white hover:to-[#cfe6fb]  border border-black/10 bg-white px-5 py-2 font-sans text-xl leading-[1.6] font-semibold text-black/80 shadow-[0_6px_16px_rgba(0,0,0,0.08)] transition-colors duration-300 dark:border-white/15 dark:bg-black dark:text-white"
                  >
                    {t}
                  </span>
                ))}
  ...
  <div className="mx-auto max-w-[1100px] px-4 sm:px-8">
    ...
    <div className="mb-14 text-center">
      <h2 className="font-heading font-bold uppercase tracking-tight
        text-[28px] sm:text-[36px] md:text-[46px] lg:text-[56px]">
                ...
                <div key={it.title} className="group relative h-full">
                  ...
                  <div className="
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="font-heading text-lg sm:text-xl md:text-2xl font-bold text-brand-blue transition-colors duration-300 dark:text-white">
                        {it.title}
                      </div>
                    ...
                    <p className="mt-4 font-sans text-sm sm:text-base md:text-lg font-medium leading-[1.6] text-black/70 transition-colors duration-300 dark:text-white/75">
                      {it.desc}
                    </p>
                  </div>
                </div>
