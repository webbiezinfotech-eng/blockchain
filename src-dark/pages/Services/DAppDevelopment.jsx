...
const monetizationIcons = [
  ...
  />
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
        ...
        <div className="mx-auto grid w-full grid-cols-1 items-start gap-0 lg:grid-cols-[65%_35%]">
          <div className="mx-4 md:mx-20 flex w-full flex-col justify-start gap-5 leading-[1.4] lg:text-left">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block text-[32px] leading-[1.2] sm:text-[32px] md:text-[58px] sm:leading-[1.25] lg:text-[68px] lg:leading-[1.50]">
                HIGH-PERFORMANCE DAPP
              </span>
              <span className="block text-[32px] leading-[1.2] sm:text-[32px] md:text-[58px] sm:leading-[1.25] lg:text-[72px] lg:leading-[1.50]">
                DEVELOPMENT FOR
              </span>
              <span className="block text-[32px] leading-[1.2] sm:text-[32px] md:text-[58px] sm:leading-[1.25] lg:text-[67px] lg:leading-[1.5-]">
      ...
      {/* Dapp Use Cases */}
    <section className="w-full bg-white py-2 transition-colors duration-300 dark:bg-black">
...
"
      ...
      {useCases.map((c, idx) => (
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col px-6 py-10 sm:p-12">
              ...
              {/* IMAGE */}
            <div className="mt-12 flex items-center justify-center rounded-xl bg-white p-4 shadow-sm dark:bg-black/40 min-h-[170px]">
              ...
              {/* TITLE */}
              <h3 className="text-center font-heading text-[20px] font-bold uppercase tracking-wide text-brand-blue dark:text-white">
                {c.title}
              </h3>

              {/* DESCRIPTION */}
              <p className="mt-3 text-center mb-14 font-sans text-[16px] leading-relaxed text-black/75 dark:text-white/85">
                {c.desc}
              </p>
    ...
    <div className="mt-6 flex items-center justify-center gap-6">
      ...
      {/* Tech Stack */}
      <section className="w-full bg-white transition-colors duration-300 dark:bg-black sm:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          ...
          <div className="mx-auto grid max-w-[1000px] grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-5 justify-items-center">
            {techStack.map((n, i) => (
              <div
                ...
                dark:border-[#ffffff]  hover:border-brand-blue hover:bg-gradient-to-b hover:from-white hover:to-[#cfe6fb]
