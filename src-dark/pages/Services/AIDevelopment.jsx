  ...
  <Helmet>
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      ...
      <section className="w-full bg-white pt-4 pb-2 transition-colors duration-300 dark:bg-black sm:pt-6 sm:pb-10 lg:pt-8 lg:pb-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="grid grid-cols-1 items-center lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            {/* Left */}
            <div>
              <h2 className="font-heading font-bold uppercase tracking-tight text-[32px] sm:text-[44px] md:text-[54px] lg:text-[70px]leading-[1.1]">
              ...
              <p className="mt-8 max-w-[720px] font-sans text-base leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75 text-sm sm:text-base md:text-lg lg:text-xl">
          ...
          <div className="mt-12 grid grid-cols-1 items-center gap-0 md:grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] lg:gap-0">
            ...
            <div className="flex w-full flex-col gap-4">
              {useCases.map((item) => (
                ...
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg  border-[#c8d7e4] bg-white transition-colors duration-300 dark:border-white/15 dark:bg-black">
                    {item.icon}
                  </div>
                  <p className="font-sans text-base font-medium text-black transition-colors duration-300 dark:text-white text-sm sm:text-base md:text-lg">
                    {item.title}
                  </p>
                </div>
              ))}
      ...
      <section className="w-full bg-white  transition-colors duration-300 dark:bg-black ">
        <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="text-center">
            <h2 className="font-heading text-[42px] font-bold uppercase tracking-tight text-black transition-colors duration-300 text-[28px] sm:text-[40px] md:text-[52px] lg:text-[68px]
 dark:text-white">
              <span className="text-black dark:text-white">AI </span>
      ...
      <section className="w-full bg-white transition-colors duration-300 dark:bg-black sm:py-10">
        <div className="mx-automt-5  max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="text-center">
            <h2 className="font-heading text-[42px] font-bold uppercase tracking-tight transition-colors duration-300 text-[28px] sm:text-[40px] md:text-[52px] lg:text-[68px]">
