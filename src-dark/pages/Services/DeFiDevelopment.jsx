  ...
  return (
    ...
    <><Helmet>
      ...
      <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
        {/* Hero */}
        <section className="relative w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pb-8 md:pt-6 md:pb-8 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-8">
          <div className="mx-auto grid w-full grid-cols-1 items-start gap-0 lg:grid-cols-[65%_35%]">
            ...
            <div className="mx-2 md:mx-20 flex w-full flex-col justify-start gap-5 leading-[1.4]">
              <h1 className="font-heading font-bold uppercase tracking-tight text-black dark:text-white">
                <span className="block text-[28px] leading-[1.2] sm:text-[42px] md:text-[52px] lg:text-[76px] lg:leading-[1.50]">
                  END-TO-END DEFI DEVELOPMENT
                </span>

                <span className="block text-[26px] leading-[1.2] sm:text-[38px] md:text-[48px] lg:text-[76px] lg:leading-[1.50]">
                  FOR{' '}
        ...
        <section className="w-full bg-white py-10">
          <div className="mx-auto max-w-layout px-2 sm:px-6 lg:px-[3rem]">
            ...
            <div className="mb-10 text-center">
              <h2 className="font-heading text-[28px] sm:text-[40px] lg:text-[72px] font-bold uppercase tracking-tight text-black">
        ...
        {/* Protocol Features */}
        <section className="w-full bg-white py-4 transition-colors duration-300 dark:bg-black sm:py-4">
                ...
                >
                  <div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-heading text-[22px] font-bold uppercase tracking-wide text-black transition-colors duration-300 dark:text-white">
                          {f.title}
                        </h3>
                        <p className="mt-2 font-sans text-[15px] sm:text-[17px] lg:text-[19px] leading-relaxed text-black/75 transition-colors duration-300 dark:text-white/85">
                          {f.desc}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-center sm:justify-end">
                    <div className=" overflow-hidden rounded-xl transition-colors duration-300 dark:bg-white/[0.06]">
        ...
        dark:border-white/25 dark:bg-black dark:text-white
        justify-self-center
      "
                  >
                    {n}
