...
const handleNext = () => {
  ...
  return (
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      {/* Hero */}
      <section className="relative w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pb-8 md:pt-6 md:pb-10 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-12">
 ...
 flex w-full flex-col justify-start gap-5 leading-[1.4]">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block leading-[1.2]  sm:leading-[1.25] text-[24px] sm:text-[36px] md:text-[48px] lg:text-[68px]  lg:leading-[1.25] ">
      ...
      {/* Token Types */}
      <section className="w-full bg-white py-8 transition-colors duration-300 dark:bg-black sm:py-4">
                    ...
                    <div className="group relative w-full max-w-[380px]">
                      ...
                      <div className="relative rounded-[24px] border border-[#c8d7e4] bg-white p-7 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300 dark:border-white/25 dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]">
                        <div className="flex items-start justify-between gap-4">
                          <h3 className="font-sans text-base sm:text-lg md:text-xl font-bold text-brand-blue transition-colors duration-300 dark:text-white">
                            {card.title}
                          </h3>
...
<div className="mt-6 flex justify-center gap-6">
  ...
  <button
    ...
    className="
      ...
      dark:bg-black/60 dark:border-white/40
    "
  >
  ...
  >
    <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="w-full bg-white py-8 transition-colors duration-300 dark:bg-black sm:py-4">
        ...
        >
          <div className="mb-12 text-center">
            <h2 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white text-[24px] sm:text-[36px] md:text-[48px] lg:text-[72px]">
            ...
            {tokenFeatures.map((f, idx) => (
              ...
              >
                <div className="flex-1">
                  <h3 className="font-semibold leading-snug text-black transition-colors duration-300 dark:text-white text-lg sm:text-xl md:text-2xl">
                    {f.title}
                  </h3>
                  <p className="mt-4 text-sm sm:text-base md:text-lg font-medium leading-[1.75] text-black/70 transition-colors duration-300 dark:text-white/80 ">
                    {f.desc}
                  </p>
                </div>

                <div className="flex w-full sm:w-[180px] shrink-0 items-center justify-center">
                  <div className="flex aspect-square w-full items-center justify-center overflow-hidden rounded-2xl transition-colors duration-300 dark:bg-black/20">
      ...
      <section className="w-full bg-white pt-6 pb-16 transition-colors duration-300 dark:bg-black sm:pt-8 sm:pb-20">
        <div className="mx-auto max-w-layout px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="mb-12 text-center">
            <h2 className="font-heading font-bold uppercase tracking-tight transition-colors duration-300 text-[24px] sm:text-[36px] md:text-[48px] lg:text-[72px]">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[55%_45%] lg:gap-14">
            <div className="w-full">
              <p className="mb-5 font-sans text-sm sm:text-base md:text-lg font-medium leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75 ">
                We help with:
              </p>
