...
const WalletDevelopment = () => {
  ...
  return (
    ...
    <div className="w-full bg-white transition-colors duration-300 dark:bg-black">
      {/* Hero */}
      <section className="relative w-full bg-white pt-4 pb-2 transition-colors duration-300 dark:bg-black sm:pb-8 md:pt-6 md:pb-8 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-6">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem] grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-[65%_35%]">
          <div className="mx-2  flex w-full flex-col justify-start gap-5 leading-[1.4]">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white">
              <span className="block leading-[1.2] sm:text-[52px] sm:leading-[1.25] text-[24px] sm:text-[36px] md:text-[48px] lg:text-[72px] lg:leading-[1.20]">
              ...
              <span className="block leading-[1.25] sm:text-[52px] sm:leading-[1.25] text-[24px] sm:text-[36px] md:text-[48px] lg:text-[72px] lg:leading-[1.20]">
      ...
      <section className="w-full bg-white pt-4 pb-8 transition-colors duration-300 dark:bg-black sm:pt-6 sm:pb-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="mb-10 text-center">
            <h2 className="font-heading text-[40px] font-bold uppercase tracking-tight text-black transition-colors duration-300 dark:text-white sm:text-[54px] lg:text-[72px]">
          ...
          <div className="mx-auto max-w-[980px]">
            ...
            <div className="hidden sm:block">
              ...
              <div className="grid grid-cols-3 gap-10 justify-items-start">
                {securityTop.map((i) => (
                  <div key={i.t} className="flex flex-col items-center">
                    <div className="flex w-[260px] min-h-[220px] flex-col items-center justify-start rounded-[10px] border border-[#c8d7e4] bg-white py-10 text-center shadow-[0_10px_28px_rgba(0,0,0,0.06)] transition-colors duration-300 dark:border-white/25 dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]">
                      ...
                      <div className="mt-4 max-w-[220px] font-sans text-[22px] font-semibold leading-snug text-black transition-colors duration-300 dark:text-white">
                        {i.t}
                      </div>
                    </div>
              ...
              {/* Middle thick line */}
            <div className="relative left-1/2 -translate-x-1/2 h-[6px] w-full max-w-[980px] bg-brand-blue dark:bg-white" />
