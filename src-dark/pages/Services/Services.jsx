     ...
     <section className="relative min-h-[90vh] md:min-h-[100vh] w-full overflow-hidden">
          ...
          <div className="mx-auto w-full max-w-layout px-5 sm:px-8 md:px-14 lg:px-[3rem]">
            <div className="max-w-[900px]">
              ...
              <h1 className="font-heading font-bold uppercase leading-tight">
                {/* Line 1 */}
                <span className="block text-[26px] leading-[1.2] sm:text-[44px] md:text-[52px] lg:text-[76px]">
      ...
      <section className="mx-auto max-w-layout px-4 sm:px-8 md:px-10 py-8 lg:py-10">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-xl leading-[1.6] sm:text-base text-black/70 dark:text-white/70">
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* CUT CARD BACKGROUND */}
                    <img
                      src={theme === 'dark' ? cutCardDbg : cutCardLbg}
                      alt=""
                      aria-hidden
                      className="
      pointer-events-none
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              {[
                ...
                <li key={item} className="flex gap-3 text-black/80 text-[20px] dark:text-white/80">
