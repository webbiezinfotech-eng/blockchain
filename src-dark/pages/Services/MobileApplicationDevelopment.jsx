      ...
      <section className="w-full bg-white pt-4 pb-2 transition-colors duration-300 dark:bg-black sm:pt-6 sm:pb-10 lg:pt-8 lg:pb-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="grid grid-cols-1 items-center lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            {/* Left */}
            <div>
              <h1 className="font-heading font-bold uppercase leading-[1.26] tracking-tight text-[28px] sm:text-[36px] md:text-[48px] lg:text-[64px] xl:text-[76px]">
        ...
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="text-center">
            <h2 className="font-heading font-bold uppercase tracking-tight text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[76px] text-black transition-colors duration-300 dark:text-white">
              <span className="text-black dark:text-white">MOBILE APP </span>
          ...
          <div className="mt-12 grid grid-cols-1 items-center lg:grid-cols-[0.95fr_1.05fr] gap-10 lg:gap-16">
            ...
            <div className="flex w-full flex-col gap-4">
              {useCases.map((item) => (
                <div
                  key={item.title}
                  className="flex hover:border-brand-blue hover:text-white items-center items-center gap-3 rounded-xl border border-[#c8d7e4] bg-white px-[10px] py-[10px] shadow-[0_2px_10px_rgba(0,0,0,0.06)] transition-colors duration-300 dark:border-white/15 dark:bg-black"
                >
                  <div className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-lg border-[#c8d7e4] bg-white transition-colors duration-300 dark:border-white/15 dark:bg-black">
                    {item.icon}
                  </div>
          ...
          <div className="relative mt-14">
            ...
            <div className="grid grid-cols-1 justify-items-center gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
              {capabilitiesTop.map((c) => (
                ...
                >
                  <div className="mx-auto mb-4 flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-md border border-brand-blue/45 bg-white transition-colors duration-300 dark:border-white/15 dark:bg-gradient-to-r dark:from-[#004b8a] dark:to-[#000000]">
                    {c.icon}
                  </div>
