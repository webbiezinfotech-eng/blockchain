  ...
  const sizeStyles =
    size === 'pill'
      ? {
          ...
          expanded:
            'w-[320px] h-[340px] sm:w-[420px] sm:h-[420px] md:w-[480px] md:h-[440px] rounded-[40px] sm:rounded-[70px] border-2 border-brand-blue/40 shadow-[0_16px_48px_rgba(0,0,0,0.25)] -translate-y-2 z-10 md:shadow-[0_24px_64px_rgba(0,0,0,0.3)]',
          collapsed:
      ...
      : size === 'compact'
        ? {
            expanded:
              'w-[260px] h-[340px] sm:w-[300px] sm:h-[400px] md:w-[340px] md:h-[420px] rounded-[32px] sm:rounded-[56px] border-2 border-brand-blue/35 shadow-[0_14px_40px_rgba(0,0,0,0.22)] -translate-y-1 z-10',
        ...
        : {
            ...
            expanded:
              'w-full h-[360px] sm:w-[360px] sm:h-[420px] md:w-[460px] md:h-[460px] rounded-[40px] sm:rounded-[70px] border-2 border-brand-blue/40 shadow-[0_16px_48px_rgba(0,0,0,0.25)] -translate-y-2 z-10 md:shadow-[0_24px_64px_rgba(0,0,0,0.3)]',
            collapsed: 'w-full sm:w-32 h-[340px] sm:h-[450px] rounded-[40px] sm:rounded-[70px]',
          };

  return (
    <div
      className={`group relative flex-shrink-0 overflow-hidden border border-brand-blue/30 bg-black/[0.03] shadow-[0_8px_24px_rgba(0,0,0,0.15)] transition-all duration-500 ease-in-out md:shadow-[0_12px_32px_rgba(0,0,0,0.18)]
        ${isExpandedState 
          ? sizeStyles.expanded
