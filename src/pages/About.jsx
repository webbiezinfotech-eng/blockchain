...
const About = () => {
        ...
        <div className="mx-auto text-center sm:text-left lg:ps-12">
          ...
          <div className="flex flex-col ml-0 p-2 sm:ml-10 gap-6">
            <h1 className="font-heading font-bold uppercase tracking-[0%] text-left">
              ...
              <div className="block w-full  transition-colors duration-300 text-[32px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[68px]">
            ...
            <p className="text-start w-full max-w-[600px] leading-[1.6] text-black transition-colors duration-300 sm:leading-[1.65] text-xl md:text-2xl">
  ...
  businesses move beyond traditional systems and adopt secure, transparent, and scalable technologies.
      ...
      ======================================== */}
      <section className="w-full bg-white pt-4 pb-8 transition-colors duration-300 sm:pt-6 sm:pb-16 md:pt-4 md:pb-20">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          <h2 className="text-center font-heading font-bold uppercase leading-[1] tracking-[0.02em] text-[32px] text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]">
            <span className="text-black transition-colors duration-300">WHO </span>
          ...
          <div className=" grid grid-cols-1 mt-8 items-center gap-6 md:mt-16 md:grid-cols-[400px_1fr] md:gap-8 lg:mt-14 lg:grid-cols-[440px_1fr] lg:gap-12">
            ...
            <div className="max-w-[600px]">
              <p className="  text-base sm:text-xl md:text-xl lg:text-2xl leading-[1.7] text-black/80 transition-colors duration-300">
              ...
              <p className="mt-6 text-base sm:text-xl md:text-xl lg:text-2xl leading-[1.7] text-black/80 transition-colors duration-300">
        ...
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          <div className="w-full rounded-[24px] border border-brand-blue/10 bg-[#c0e1e23b] p-5 transition-all duration-300 sm:p-8 lg:p-10">
            ...
            <div className="mt-6 space-y-4 md:mt-8 lg:mt-10">
              <p className="text-base sm:text-xl md:text-xl lg:text-2xl  leading-[1.6] text-black/80 transition-colors duration-300">
      ...
      ======================================== */}
      <section className="w-full bg-white py-4 transition-colors duration-300 sm:py-8 md:py-10">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          <h2 className="text-center font-heading font-bold uppercase leading-[1] tracking-[0.02em] text-[32px] text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 lg:gap-12">
            {/* Mission Card */}
            <div className="rounded-[24px] border border-brand-blue/20 bg-white p-8 transition-all duration-300 hover:shadow-lg sm:p-10">
              ...
              <p className="mt-6 text-xl leading-[1.6] text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
      ...
      ======================================== */}
      <section className="w-full bg-white pb-16  transition-colors duration-300">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          <h2 className="text-center font-heading font-bold uppercase leading-[1] tracking-[0.02em] text-[32px] text-[28px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]">
            <span className="text-black transition-colors duration-300">OUR </span>
          ...
          <div className="grid grid-cols-1 items-center lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-6 ml-[30px] lg:ml-[58px]">
              ...
              <div className="max-w-[750px] space-y-4">
                <p className="font-sans text-xl leading-[1.6] font-medium  text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
                ...
                <div className="space-y-2">
                  <h3 className="font-heading text-xl text-black transition-colors duration-300 sm:text-xl md:text-2xl">
                  ...
                  <div className="space-y-1">
                    {[
                      ...
                      <p key={idx} className="flex items-start gap-3 font-sans text-xl font-large leading-[1.6] text-black/75 transition-colors duration-300 sm:text-base">
                ...
                <p className="font-sans text-xl font-medium leading-[1.6] text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
      ...
      ======================================== */}
      <section className="w-full bg-white py-8 transition-colors duration-300 sm:py-12 md:py-10">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <p className="mt-4 text-center font-sans text-xl font-medium text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-10">
            ...
            <div className="group relative rounded-[24px] border border-brand-blue/30 bg-white p-8 transition-all duration-300 hover:border-brand-blue hover:shadow-xl sm:p-10">
              ...
              <ul className="mt-8">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3 font-sans text-xlleading-[1.6] font-medium leading-none text-black/80 sm:text-base py-1">
                    <span className="mt-2 h-1 w-1 flex-shrink-0 rounded-full bg-black/40" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="group relative rounded-[24px] border border-brand-blue/30 bg-white p-8 transition-all duration-300 hover:border-brand-blue hover:shadow-xl sm:p-10">
              ...
              <ul className="mt-8">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3 font-sans text-xl leading-[1.6] font-medium leading-none text-black/80 sm:text-base py-1">
                    <span className="mt-2 h-1 w-1 flex-shrink-0 rounded-full bg-black/40" />
                    <span>{item}</span>
                  </li>
                ))}
          ...
          <div className="group mt-10 w-full rounded-[24px] border border-brand-blue/30 bg-white p-8 transition-all duration-300 hover:border-brand-blue hover:shadow-xl sm:mt-12 sm:p-10 lg:p-12">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                ...
                <div key={idx} className="flex items-center  hover:text-brand-blue hover:border-brand-blue hover:bg-gradient-to-b hover:from-white hover:to-[#cfe6fb] justify-center rounded-xl border border-black/10 bg-white px-2 py-3 text-center font-sans text[28px] leading-[1.6] font-medium text-black/80 transition-all duration-300  sm:text-base">
                  {tech}
                </div>
              ))}
            </div>

            <p className="mt-10 text-center font-sans text-xl leading-[1.6] font-medium text-black/70 transition-colors duration-300 sm:text-base">
      ...
      ======================================== */}
      <section className="w-full bg-white py-14 transition-colors duration-300 sm:py-16 md:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          <h2 className="text-center font-heading font-bold uppercase leading-[1.1] tracking-[0.02em] text-[34px] sm:text-[46px] md:text-[50px] lg:text-[55px]">
            OUR <span className="text-brand-blue">APPROACH</span>
          </h2>
          <p className="mt-4 text-center font-sans text-xl leading-[1.6] font-medium text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
      ...
      ======================================== */}
      <section className="w-full bg-white py-16 transition-colors duration-300 sm:py-20">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-20">
          ...
          <div className="flex justify-center">
            <p className="mt-4 max-w-[600px] text-center font-sans text-xl leading-[1.6] font-medium text-black/80 transition-colors duration-300 sm:text-base md:text-xl">
              ...
              {[
                ...
                <div key={idx} className={`relative flex flex-col items-center md:flex-row ${idx % 2 === 0 ? 'md:justify-center' : 'md:justify-center'}`}>
                  ...
                  <div className={`relative w-full pl-16 md:w-[42%]  ${idx % 2 === 0 ? 'md:pr-12' : 'md:pl-14 md:order-2'}`}>
                    ...
                    <div className="flex min-h-[180px] flex-col justify-center rounded-2xl border-2 border-brand-blue/30 bg-white p-6 shadow-sm transition-all duration-300 hover:border-brand-blue hover:shadow-lg sm:p-8">
                      <h3 className="no-stroke font-heading text-xl font-bold text-brand-blue sm:text-2xl">{item.title}</h3>
                      <p className="mt-4 max-w-[350px] font-sans text-base font-medium leading-[1.6] text-black/80">
                        {item.desc}
                      </p>
                    </div>
                  </div>
