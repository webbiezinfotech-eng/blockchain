      ...
      <section className="w-full bg-white pt-10 pb-14 transition-colors duration-300 dark:bg-black sm:pt-12 sm:pb-16">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[42%_58%] lg:gap-14">
            ...
            {/* Right list */}
            <div className="flex w-full flex-col gap-4 lg:ml-auto lg:max-w-[520px]">
          ...
          <div className="mx-auto max-w-[980px]">
              ...
              <div className="grid grid-cols-4 gap-10">
                {checklistTop.map((i) => (
                  <div key={i.t} className="flex flex-col items-center">
                    <div className="flex w-full max-w-[220px] flex-col items-center rounded-[10px] border border-[#c8d7e4] bg-white px-5 py-6 text-center shadow-[0_10px_28px_rgba(0,0,0,0.06)] transition-colors duration-300 dark:border-white/25 dark:bg-black">
              ...
              <div className="grid grid-cols-4 gap-10">
                {checklistBottom.map((i) => (
                  <div key={i.t} className="flex flex-col items-center">
                    ...
                    <div className="mt-8 flex w-full max-w-[220px] flex-col items-center rounded-[10px] border border-[#c8d7e4] bg-white px-5 py-6 text-center shadow-[0_10px_28px_rgba(0,0,0,0.06)] transition-colors duration-300 dark:border-white/25 dark:bg-black">
                      <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-brand-blue/45 bg-white text-brand-blue transition-colors duration-300 dark:border-white/30 dark:bg-black dark:text-white">
                        <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                          <path d="M12 2 20 6v6c0 5-3.5 9.5-8 10-4.5-.5-8-5-8-10V6l8-4Z" stroke="currentColor" strokeWidth="1.7" />
                        </svg>
            ...
            <div className="grid grid-cols-2 gap-5 sm:hidden">
              {[...checklistTop, ...checklistBottom].map((i) => (
                <div
                  key={i.t}
                  className="flex flex-col items-center rounded-[10px] border border-[#c8d7e4] bg-white px-4 py-5 text-center shadow-[0_10px_28px_rgba(0,0,0,0.06)] transition-colors duration-300 dark:border-white/25 dark:bg-black"
                >
      ...
      <section className="w-full bg-white pt-4 pb-14 transition-colors duration-300 dark:bg-black sm:pt-6 sm:pb-16">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          ...
          <div className="mx-auto grid max-w-[980px] grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-[12px] border border-black/10 bg-white p-6 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300 dark:border-white/25 dark:bg-black">
