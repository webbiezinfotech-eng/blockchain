...
/>
      ...
      <section className="w-full bg-white py-4 transition-colors duration-300 sm:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          ...
          <div className="mb-12 text-center">
            <h2 className="font-heading font-bold uppercase tracking-tight text-black text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[68px]">
          ...
          "
              >
                ...
                <div>
                  ...
                  {/* Description */}
                  <p className="mt-3 max-w-[780px] font-sans text-[16px] sm:text-[20px] leading-[1.7] text-black/75">
                    {c.description}
                  </p>

                  {/* Develop Section */}
                  <div className="mt-6">
                    <p className="font-sans text-[18px] font-bold uppercase tracking-wide text-black">
                      {c.developHeading}
                    </p>
                    ...
                    <ul className="mt-3 space-y-2">
                      {c.developPoints.map((point) => (
                        <li key={point} className="flex items-start gap-3">
                          ...
                          <span className="font-sans text-[19px] text-black/75">
                            {point}
                          </span>
                        </li>
                      ))}
                  ...
                  {/* Benefits */}
                  <div className="mt-6">
                    <p className="font-sans text-[14px] font-bold uppercase tracking-wide text-black">
                      {c.benefitsHeading}
                    </p>
                ...
                <div className="flex items-center justify-center lg:justify-end">
                  <div className="w-full max-w-[350px] overflow-hidden rounded-2xl bg-black/[0.03]">
                    <img
                      src={c.image}
                      alt={c.title}
                      className="h-full w-full object-cover"
      ...
      <section className="w-full bg-white pt-2 pb-16 transition-colors duration-300 sm:pt-4 sm:pb-20">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="mb-10 text-center">
            <h2 className="font-heading text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px] font-bold uppercase tracking-tight transition-colors duration-300 sm:text-[48px] lg:text-[60px]">

              <span className="text-black transition-colors duration-300">OUR</span>
              <span className="text-brand-blue">  Development Process</span>
            </h2>
          </div>
           ...
           <div className="grid grid-cols-1 gap-14 sm:grid-cols-2 sm:gap-16 lg:grid-cols-3">
              {process.map((it) => (
                <div key={it.title} className="group relative">
                  ...
                  {/* Foreground card */}
                  <div className="relative rounded-[22px] border border-[#c8d7e4] bg-white p-7 shadow-[0_10px_28px_rgba(0,0,0,0.10)] transition-colors duration-300">
                    <div className="flex items-start justify-between gap-4">
                      <div className="font-heading text-[24px] font-bold text-brand-blue transition-colors duration-300">
                        {it.title}
                      </div>
                    ...
                    <p className="mt-4 font-sans text-[19px] font-medium leading-[1.6] text-black/70 transition-colors duration-300">
                      {it.desc}
                    </p>
                  </div>
                </div>
      ...
      <section className="w-full bg-white py-4 transition-colors duration-300 sm:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          ...
          <div className="mb-14 text-center">
            <h2 className="font-heading text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px] font-bold uppercase tracking-tight">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
            {technologies.map((t) => (
              <div
                key={t.k}
                className="relative rounded-xl bg-white shadow-[0_8px_24px_rgba(0,0,0,0.12)]"
                style={{
                  fontFamily:
              ...
              >
                ...
                <div className="px-6 py-5">
                  <p className="text-[18px] font-bold uppercase text-black">
                    {t.k}:
                    <span className="ml-2 font-normal uppercase text-black/90">
                      {t.v.join(", ")}
                    </span>
                  </p>
                </div>
      ...
      <section className="w-full bg-white py-14 transition-colors duration-300 sm:py-16">
        <div className="mx-auto grid w-full max-w-layout grid-cols-1 items-center gap-10 px-6 sm:px-10 md:px-16 lg:grid-cols-[42%_58%] lg:pl-[3rem] lg:pr-[5rem]">
          ...
          {/* Content */}
          <div>
            <h2 className="font-heading text-[32px] sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[50px] font-bold uppercase tracking-tight text-black transition-colors duration-300 sm:text-[48px] lg:text-[60px]">
              WHY CHOOSE{" "}
            ...
            hover:shadow-[0_14px_36px_rgba(0,0,0,0.12)]"
                >
                  {/* Icon */}
                  <div className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg  border-brand-blue/35 bg-black/[0.02] text-brand-blue">
  <img
        ...
        />
                  ...
                  {/* Text */}
                  <p className="font-sans text-[16px] font-semibold leading-relaxed text-black/80 transition-colors duration-300 sm:text-[17px]">
                    {item}
                  </p>
                </div>
              ))}
