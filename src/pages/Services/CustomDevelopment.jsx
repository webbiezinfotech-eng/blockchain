...
import capability1Img from '../../assets/home_images/frontend-capability.png';
import capability2Img from '../../assets/home_images/blockchain-api.png';
import capability3Img from '../../assets/home_images/walletdev.png';

import chooseImg from '../../assets/home_images/scalable-infras.png';
...
const CustomDevelopment = () => {
  ...
  const process = [
    { title: 'Discovery & Planning', desc: 'Requirements, scope, timelines, and success metrics.' },
    { title: 'UI/UX Design', desc: 'Wireframes, prototypes, and delightful user experience.' },
    { title: 'Development', desc: 'Agile delivery with clean, maintainable code.' },
    { title: 'Testing & QA', desc: 'Functional, performance, and security testing.' },
    { title: 'Deployment', desc: 'Production rollout, monitoring, and CI/CD setup.' },
    { title: 'Maintenance & Support', desc: 'Ongoing improvements, fixes, and scaling.' },
  ];
