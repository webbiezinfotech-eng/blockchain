...
const TermsConditions = () => {
  return (
    <div className="w-full bg-white transition-colors duration-300">
      {/* Hero Section */}
      <section className="w-full bg-white pb-5 pt-5 transition-colors duration-300 sm:pb-12 ">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="text-center">
            <h1 className="font-heading font-bold uppercase tracking-tight text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px] xl:text-[76px] text-black transition-colors duration-300">
      ...
      <BeforeFooter title="Questions About Our Terms?" buttonText="Contact Us" buttonLink='/contact'/>
    </div>
  );
};
