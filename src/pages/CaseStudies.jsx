...
import heroImg from '../assets/Casestudies_images/Casestudies-hero.png';
          ...
          <div className="flex w-full flex-col gap-6">
            ...
            <p className="max-w-[820px] font-sans text-base font-medium leading-[1.7] text-black/75 transition-colors duration-300 dark:text-white/75 sm:text-lg">
              ...
              <span className="mt-3 block">
                Each case study outlines the <span className="font-semibold text-brand-blue dark:text-white">Problem</span> —{' '}
                <span className="font-semibold text-brand-blue dark:text-white">Solution</span> —{' '}
                <span className="font-semibold text-brand-blue dark:text-white">Results</span>, showcasing measurable business value.
              </span>
            </p>
          </div>
        ...
        >
          ...
          <div
            className="
              ...
              bg-black/[0.03]
              shadow-[0_16px_36px_rgba(0,0,0,0.16)]
              transition-all duration-300
              group-hover:-translate-y-[6px]
              group-hover:border-brand-blue/60
              group-hover:shadow-[0_24px_50px_rgba(0,0,0,0.22)]
          ...
          {/* TITLE */}
          <div className="mt-6 text-center font-heading text-[14px] font-bold uppercase leading-snug tracking-wide text-black dark:text-white">
            {f.title.split('\n').map((line) => (
