...
const Industries = () => {
  ...
  <Helmet>
    ...
    <div className="w-full bg-white transition-colors duration-300">
      {/* Hero */}
      <section className="relative w-full bg-white pt-4 pb-4 transition-colors duration-300 sm:pb-16 md:pt-6 md:pb-8 lg:pt-8 lg:pb-8 xl:pt-10 xl:pb-8">
        <div className="mx-auto grid w-full max-w-layout grid-cols-1 items-center gap-10 px-6 sm:px-10 md:px-16 lg:grid-cols-[58%_42%] lg:pl-[3rem] lg:pr-[5rem]">
          <div className="flex w-full flex-col gap-6">
            <h1 className="font-heading font-bold uppercase tracking-tight text-black transition-colors duration-300">
              <span className="block leading-[1.2]  sm:leading-[1.25] text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px] lg:leading-[1.25]">
                TRANSFORMING INDUSTRIES
              </span>
              <span className="block  leading-[1.2]  sm:leading-[1.25] text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px] lg:leading-[1.25]">
                WITH{' '}
                <span className="text-brand-blue">BLOCKCHAIN &amp;</span> {' '}
                <span className="text-brand-blue">AI INNOVATION</span>
              </span>
      ...
      {/* Industry Categories */}
      <section data-aos="fade-up" className="w-full bg-white py-4 transition-colors duration-300 sm:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">

          {/* Heading */}
          <div className="mb-12 text-center">
            <h2 className="font-heading text-[40px] font-bold uppercase tracking-tight text-black transition-colors duration-300 text-[32px]  sm:text-[36px] md:text-[44px] lg:text-[56px] xl:text-[72px]">
...
h-[150px] w-[110px] sm:h-[170px] sm:w-[120px] md:h-[190px] md:w-[130px]
            ...
            "
                ...
                {/* TITLE */}
                <div className="mt-5 text-center font-heading text-[14px] sm:text-[16px] md:text-[18px] font-bold uppercase leading-snug tracking-wide text-black transition-colors duration-300">
                  {c.title.split('\n').map((line) => (
      ...
      <section className="w-full bg-white py-4 transition-colors duration-300 sm:py-8">
        <div className="mx-auto max-w-layout px-6 sm:px-10 md:px-16 lg:px-[3rem]">
          <div className="mb-10 text-center">
            <h2 className="font-heading  font-bold uppercase tracking-tight text-black transition-colors duration-300 sm:text-[54px] lg:text-[72px]">
      ...
      md:grid-cols-[1fr_360px] lg:grid-cols-[1fr_420px]"
              >
                {/* LEFT CONTENT */}
                <div>
                  <h3 className="font-heading text-[24px] font-bold text-black">
                    {it.title}
                  </h3>

                  <p className="mt-3 max-w-[520px] font-sans text-[18px] sm:text-[16px] md:text-[20px] leading-relaxed text-black/75">
                    {it.description}
                  </p>

                  {/* Use Cases */}
                  <div className="mt-6">
                    <div className="font-sans text-[15px] sm:text-[16px] md:text-[18px] font-bold uppercase text-black">
                      Use Cases
                    </div>
                    <ul className="mt-3 space-y-2">
                      {it.useCases.map((u) => (
                        <li key={u} className="flex gap-3">
                          ...
                          <span className="font-sans text-[15px] sm:text-[16px] md:text-[18px] text-black/75">
                            {u}
                          </span>
                        </li>
                      ))}
                  ...
                  {/* Benefits */}
                  <div className="mt-6">
                    <div className="font-sans text-[14px] font-bold text-black">
                      Benefits
                    </div>
